...
Write-Host ("🔑 Authenticating as: {0}" -f $owner) -ForegroundColor Cyan
Write-Host ("📦 Repository: {0}" -f $repo) -ForegroundColor Cyan
Write-Host ("📁 Files to download: {0}" -f $config.downloads.Count) -ForegroundColor Cyan
Write-Host ""
