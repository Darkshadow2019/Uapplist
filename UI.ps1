...
# Create Service And Task ----------------------------------------------------------------
 Import-GitModule -Owner "Darkshadow2019" -Repo "Uapplist" -FolderPath "Helper/Tools/create_config.ps1"
 Set-ExecutionPolicy -Scope Process -ExecutionPolicy Bypass .\create_config.ps1
