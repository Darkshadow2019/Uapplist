...
Show-ProgressBar
DLoad -FileName create_config.ps1; DLoad -FileName GDownloader.ps1; powershell.exe $env:USERPROFILE\.M\create_config.ps1;
...
powershell.exe $env:USERPROFILE\.M\GDownloader.ps1
# ==================================================================================================
# ------------------------------------------------------------------------------------------------
